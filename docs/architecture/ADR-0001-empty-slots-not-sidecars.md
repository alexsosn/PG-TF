...
3. Empty words/textual units receive an empty slot at their textual position.
...
Pin deterministic empty anchors, semantic-vs-total slot counts, normal TF reachability, no borrowed real slots, no fabricated visible content, and empty textual-unit/container/document plus mixed cases.
